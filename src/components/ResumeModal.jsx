               ...
               >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem 2rem', borderBottom: '1px solid rgba(255,255,255,0.05)', background: '#1a1a1a' }}>
                     ...
                     <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        <a href={`${import.meta.env.BASE_URL}resume.pdf`} target="_blank" rel="noreferrer" className="tech-pill" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.85rem', textDecoration: 'none', cursor: 'pointer', background: 'rgba(255,255,255,0.1)', color: '#fff', border: 'none', padding: '0.6rem 1rem', borderRadius: '8px' }}>
                           <ExternalLink size={16} /> View in Browser
                        </a>

                        <a href={`${import.meta.env.BASE_URL}resume.pdf`} download="Vamsikrishna_Resume.pdf" className="tech-pill" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.85rem', background: 'var(--accent-purple)', color: '#000', textDecoration: 'none', fontWeight: 'bold', border: 'none', cursor: 'pointer', padding: '0.6rem 1rem', borderRadius: '8px' }}>
